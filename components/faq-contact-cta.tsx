...
export function FaqContactCta() {
  return (
    <div className="mt-10 flex flex-col items-center gap-4 rounded-2xl border border-white/10 bg-[#111] p-6 text-center">
      <p className="text-sm text-white/90">Nog een vraag? Boek direct — wij denken graag met je mee.</p>
      <div className="flex w-full max-w-md flex-col gap-3 sm:flex-row sm:justify-center">
        ...
        <PhoneLink
          showIcon
          className="inline-flex flex-1 items-center justify-center rounded-full border border-white/20 bg-white/[0.06] px-5 py-3 text-xs font-semibold uppercase tracking-[0.12em] text-white"
        />
      </div>
